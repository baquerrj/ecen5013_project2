...
#define LED0_ON     (led_on(LED0_BRIGHTNESS))
#define LED1_ON     (led_on(LED1_BRIGHTNESS))
#define LED2_ON     (led_on(LED2_BRIGHTNESS))
#define LED3_ON     (led_on(LED3_BRIGHTNESS))

#define LED0_OFF    (led_off(LED0_BRIGHTNESS))
#define LED1_OFF    (led_off(LED1_BRIGHTNESS))
#define LED2_OFF    (led_off(LED2_BRIGHTNESS))
#define LED3_OFF    (led_off(LED3_BRIGHTNESS))
